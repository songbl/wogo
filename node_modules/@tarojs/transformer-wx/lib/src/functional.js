            ...
            `);
                    ...
                    if (arg) {
                        if (t.isIdentifier(arg)) {
                            insertDecls.push(utils_1.buildConstVariableDeclaration(arg.name, t.memberExpression(t.thisExpression(), t.identifier('props'))));
                            propsIdentifier = arg;
                        }
                            ...
                            insertDecls.push(t.variableDeclaration('const', [
                        ...
                        JSXExpressionContainer(path) {
                            ...
                            if (t.isMemberExpression(expr)) {
                                ...
                                if (t.isIdentifier(object) &&
                                    ...
                                    path.set('expression', t.memberExpression(t.memberExpression(t.thisExpression(), t.identifier('props')), t.identifier(property.name)));
                                }
                            }
                            else if (t.isIdentifier(expr)) {
                                if (!renderFnReg.test(expr.name))
                                    return;
                                const prop = propsList.find(prop => prop === expr.name);
                                if (!prop)
                                    return;
                                path.set('expression', t.memberExpression(t.memberExpression(t.thisExpression(), t.identifier('props')), t.identifier(expr.name)));
                            }
                        }
                    });
